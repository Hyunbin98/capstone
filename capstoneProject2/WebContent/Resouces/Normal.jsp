	...
	<div class="container">
		...
		<div class = "row">
			...
			<table class="table table-striped" style="text-align:center; border:1px solid #dddddd"> 
				...
				File oFile = new File("C:\\Users\\hyhyu\\eclipse-workspace\\capstoneProject2\\WebContent\\Resouces\\middleword.txt");
				...
				for(int i=0; i<engarray.size();i++)
				{
					...
					{
						if(engarray.get(i).equals(lineList.get(j)))
						{
							engarray.remove(i);
							korarray.remove(i);
						}
